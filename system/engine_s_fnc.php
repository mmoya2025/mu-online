...
if($mvcore['db_season'] != '1') { //If Not Season 1
	...
	$nameselects= mssql_query("Select item_name,durability,equip_level,can_buy,max_excellent,has_refinery,is_socket,is_ancient,category,id,clases from MVCore_Wshopp where id='".$sy."' and category='".$itemtype."'");
	$nameselect= mssql_fetch_row($nameselects);
	
		if($ac == '5') {
			$select_anc_info= mssql_query("Select anc_name,item_id,item_cat from MVCore_Wshopp_Ancient where item_id='".$sy."' and item_cat='".$itemtype."'");
			$s_anc_i= mssql_fetch_row($select_anc_info);
		} elseif($ac == '10') {
			$select_anc_info= mssql_query("Select anc_name2,item_id,item_cat from MVCore_Wshopp_Ancient where item_id='".$sy."' and item_cat='".$itemtype."'");
			$s_anc_i= mssql_fetch_row($select_anc_info);
		};

$select_anc_infoopt= mssql_query("Select anc_name,options from MVCore_Wshopp_Ancient_Opt where anc_id='".$s_anc_i[0]."'");
$s_anc_iopt= mssql_fetch_row($select_anc_infoopt);

if($ac == '5' || $ac == '10'){$anc_name = $s_anc_iopt[0]; $acp_anc_name = $s_anc_i[0]; $anc_option = '<br><font color=#e4ca6d>Set Item Options</font><br><br><font color=#666666>'.$s_anc_iopt[1].'</font><br>';}
else{$anc_name = ''; $anc_option = '';};

if($sy == '37' && $itemtype == '13' && $ioo == '04') { $fenrir='Life 200 increase<br>200 increases<br>Attack power 33 increases<br>Defense power 16 increases<br><br><font color=#01DF01>Extremely rare and given only to the worthy.<br>It is produced in limited quantitues.</font>';}
elseif($sy == '37' && $itemtype == '13' && $ioo == '02') { $fenrir='Absorb final damage 10%<br>Increase speed';}
elseif($sy == '37' && $itemtype == '13' && $ioo == '01') { $fenrir='Absorb final defense 10%<br>Increase speed';}
elseif($sy == '0' && $itemtype == '13') { $fenrir='Absorb 20% of Demage<br>Max HP +50 increased';}
elseif($sy == '1' && $itemtype == '13') { $fenrir='Increase 30% of attacking & Wizardry Dmg';}
elseif($sy == '4' && $itemtype == '13') { $fenrir='Increases defensive skill + 225<br>Absorb 15% additional damage<br>Increase 2 possible attack distance';}
elseif($sy == '5' && $itemtype == '13') { $fenrir='Dmg(rate): 180-200 (1000)<br>Attack speed: 20';}
elseif($sy == '64' && $itemtype == '13') { $fenrir='Damage, horsepower, improve jeojuryeck 40%<br>Attack Speed + 10';}
elseif($sy == '65' && $itemtype == '13') { $fenrir='Absorb 30% of monster attack.<br>Maximum Health + 50';}
else { $fenrir='';}
...
if($drop_item_upg[3] == '26') {
	//Upgrade System
	if($itemtype == '0' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Additional damage + 200<br>Attack success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '2' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Additional damage + 200<br>Attack success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '4' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Additional damage + 200<br>Attack success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '5' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Additional damage + 200<br>Attack success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '7' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>SD recovery rate increase + 20<br>Defence success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '8' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>SD auto recovery<br>Defence success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '9' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Defensive skill + 200<br>Defence success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '10' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Max HP increase + 200<br>Defence success rate increase + 10 <font color=green>)</font><br><br>';}
	elseif($itemtype == '11' && $item_refinary > '0') { $drop_plus_level = ''; $ref='<font color=green>+ ( </font>Max SD increase + 700<br>Defence success rate increase + 10 <font color=green>)</font><br><br>';}
	else { $drop_plus_level = ''; $ref='';}
	//end
} else {
	if($itemtype == '0' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Additional damage + 200<br>Attack success rate increase + 10<br><br>';}
	elseif($itemtype == '2' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Additional damage + 200<br>Attack success rate increase + 10<br><br>';}
	elseif($itemtype == '4' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Additional damage + 200<br>Attack success rate increase + 10<br><br>';}
	elseif($itemtype == '5' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Additional damage + 200<br>Attack success rate increase + 10<br><br>';}
	elseif($itemtype == '7' && $item_refinary > '0') { $acp_refsa = '1'; $ref='SD recovery rate increase + 20<br>Defence success rate increase + 10<br><br>';}
	elseif($itemtype == '8' && $item_refinary > '0') { $acp_refsa = '1'; $ref='SD auto recovery<br>Defence success rate increase + 10<br><br>';}
	elseif($itemtype == '9' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Defensive skill + 200<br>Defence success rate increase + 10<br><br>';}
	elseif($itemtype == '10' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Max HP increase + 200<br>Defence success rate increase + 10<br><br>';}
	elseif($itemtype == '11' && $item_refinary > '0') { $acp_refsa = '1'; $ref='Max SD increase + 700<br>Defence success rate increase + 10<br><br>';}
	else { $ref='';}
};
...
if( $itemtype == 12 && $sy >= 221 && $sy <= 261 ) {
	...
	if($item_socket[1] == '' && $item_socket[1] != '0' || $item_socket[1] == $sk_type_drop || $item_socket[1] == '-1' && $item_socket[1] != '0'){$socketinfos = '';} else {$socketinfos = '<br>Socket Options On Item<br><br>';};
}

// Socket 1 Information Select
$select_sok_info1= mssql_query("Select sok_id,sok_name from MVCore_Wshopp_Socket where sok_id='".$item_socket1."'");
$s_sok_i1= mssql_fetch_row($select_sok_info1);
if($item_socket[1] == '' && $item_socket[1] != '0' || $item_socket[1] == $sk_type_drop || $item_socket[1] == '-1' && $item_socket[1] != '0') {$sok_info_drop1 ='';} else { $acp_socket1 = $s_sok_i1[1]; $sok_info_drop1 = '<font color=#7fb2ff>'.$s_sok_i1[1].'</font><br>';}; // Socket 1
// End Select

// Socket 2 Information Select
$select_sok_info2= mssql_query("Select sok_id,sok_name from MVCore_Wshopp_Socket where sok_id='".$item_socket2."'");
$s_sok_i2= mssql_fetch_row($select_sok_info2);
if($item_socket[2] == '' && $item_socket[2] != '0' || $item_socket[2] == $sk_type_drop || $item_socket[2] == '-1' && $item_socket[2] != '0') {$sok_info_drop2 ='';} else { $acp_socket2 = $s_sok_i2[1]; $sok_info_drop2 = '<font color=#7fb2ff>'.$s_sok_i2[1].'</font><br>';}; // Socket 2
// End Select

// Socket 3 Information Select
$select_sok_info3= mssql_query("Select sok_id,sok_name from MVCore_Wshopp_Socket where sok_id='".$item_socket3."'");
$s_sok_i3= mssql_fetch_row($select_sok_info3);
if($item_socket[3] == '' && $item_socket[3] != '0' || $item_socket[3] == $sk_type_drop || $item_socket[3] == '-1' && $item_socket[3] != '0') {$sok_info_drop3 ='';} else { $acp_socket3 = $s_sok_i3[1]; $sok_info_drop3 = '<font color=#7fb2ff>'.$s_sok_i3[1].'</font><br>';}; // Socket 3
// End Select

// Socket 4 Information Select
$select_sok_info4= mssql_query("Select sok_id,sok_name from MVCore_Wshopp_Socket where sok_id='".$item_socket4."'");
$s_sok_i4= mssql_fetch_row($select_sok_info4);
if($item_socket[4] == '' && $item_socket[41] != '0' || $item_socket[4] == $sk_type_drop || $item_socket[4] == '-1' && $item_socket[4] != '0') {$sok_info_drop4 ='';} else { $acp_socket4 = $s_sok_i4[1]; $sok_info_drop4 = '<font color=#7fb2ff>'.$s_sok_i4[1].'</font><br>';}; // Socket 4
// End Select

// Socket 5 Information Select
$select_sok_info5= mssql_query("Select sok_id,sok_name from MVCore_Wshopp_Socket where sok_id='".$item_socket5."'");
$s_sok_i5= mssql_fetch_row($select_sok_info5);
if($item_socket[5] == '' && $item_socket[5] != '0' || $item_socket[5] == $sk_type_drop || $item_socket[5] == '-1' && $item_socket[5] != '0') {$sok_info_drop5 ='';} else { $acp_socket5 = $s_sok_i5[1]; $sok_info_drop5 = '<font color=#7fb2ff>'.$s_sok_i5[1].'</font><br>';}; // Socket 5
// End Select
...
if($itemtype >= '0' && $itemtype <= '4'){$item_type_kod = '1';}
elseif($itemtype == '5'){$item_type_kod = '2';}
elseif($itemtype >= '6' && $itemtype <= '11'){$item_type_kod = '3';}
else {$item_type_kod = '1';}
$select_joh_info= mssql_query("Select joh_id,joh_val,joh_name,joh_cost from MVCore_Wshopp_Harmony where joh_id='".$item_harmony."' and joh_val='".$item_harm_val."' and joh_type='".$item_type_kod."'");
