...
if($mvcore['soc_opt_buy'] == 'yes') {
	...
	$select_soc_infod1= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_socket1."'"); $check_soc_infod1 = mssql_fetch_row($select_soc_infod1);
	$select_soc_infod2= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_socket2."'"); $check_soc_infod2 = mssql_fetch_row($select_soc_infod2);
	$select_soc_infod3= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_socket3."'"); $check_soc_infod3 = mssql_fetch_row($select_soc_infod3);
	$select_soc_infod4= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_socket4."'"); $check_soc_infod4 = mssql_fetch_row($select_soc_infod4);
	$select_soc_infod5= mssql_query("Select sok_on_off from MVCore_Wshopp_Socket where sok_id='".$item_socket5."'"); $check_soc_infod5 = mssql_fetch_row($select_soc_infod5);
