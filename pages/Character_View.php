...
<?php if(!$mvcore['Character_View'] == 'on') { echo'<div '.$mvcore['e_Warning'].'>'.eng_for_the_moment_tpi_disabled.'</div>'; } ?>
...
} else { $drop_item_info = ''.main_p_character_view_playeritemhiden.' <br><b>'.main_p_character_view_hidden.'</b>'; }; if($pvsCharacterView != 'ok4581') { exit; };
} else { $drop_item_info = ''.main_p_character_view_playeritemhiden.' <br><b>'.main_p_character_view_hidden.'</b>'; };
